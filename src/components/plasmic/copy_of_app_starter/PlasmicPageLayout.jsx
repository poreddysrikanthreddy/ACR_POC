...
import sty from "./PlasmicPageLayout.module.css"; // plasmic-import: HL0xL_9I3Xn/css
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: F2xiB46suwHU/icon
import Icon2Icon from "./icons/PlasmicIcon__Icon2"; // plasmic-import: qKnnnofJVG7B/icon
...
function PlasmicPageLayout__RenderFunc(props) {
  ...
  return (
    <RichLayout
      ...
      logoElement={
        <Icon2Icon
          className={classNames(projectcss.all, sty.svg___6Mx5)}
          role={"img"}
        />
      }
      navMenuItems={[
    ...
    >
      <LoadingBoundary
        ...
        loadingState={
          <ph.DataCtxReader>
            {$ctx =>
              true ? (
                <div className={classNames(projectcss.all, sty.freeBox__zA1Xp)}>
                  <IconIcon
                    className={classNames(projectcss.all, sty.svg__cxgCc)}
                    role={"img"}
                  />
                </div>
              ) : null
      ...
      >
        <ph.DataCtxReader>
          {$ctx =>
            true ? (
              <div className={classNames(projectcss.all, sty.freeBox__zCmHj)}>
                {p.renderPlasmicSlot({
                  defaultContents: (
                    <section
                      className={classNames(projectcss.all, sty.section__nIzCy)}
                    >
                      <h1
                        className={classNames(
                          projectcss.all,
